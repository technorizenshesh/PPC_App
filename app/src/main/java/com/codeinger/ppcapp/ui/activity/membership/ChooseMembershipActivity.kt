...
import com.codeinger.ppcapp.databinding.ActivityChooseMembershipBinding
import com.codeinger.ppcapp.model.MemberShipPlanModel
import com.codeinger.ppcapp.retrofit.Constant
import com.codeinger.ppcapp.ui.activity.authentication.PurchaseMemberShipAct
import com.codeinger.ppcapp.ui.adapter.ChooseMembershipAdapter
...
class ChooseMembershipActivity : AppCompatActivity() {
    ...
    private fun getPlan() {
        ...
        WebServiceClient.client1.create(BackEndApi::class.java).getMembershipPlan()
